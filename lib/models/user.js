...
UserSchema.methods = {
  ...
  saveToTriplestore: function(done){
    ...
    var str = util.format('sorelcom:%s rdf:type sioc:UserAccount .', id) +
      util.format('sorelcom:%s sioc:email "%s" .',               id, this.email) +
      util.format('sorelcom:%s sioc:name "%s" .',               id, this.name) +
      util.format('sorelcom:%s sioc:avatar "%s" .',          id, this.avatar) +
      util.format('sorelcom:%s sioc:creator_of () .',         id);
